...
(function()
{
 var Global=this,Runtime=this.IntelliFactory.Runtime,jQuery,UI,Next,Var,List,Doc,View1,WebSharperSpa,Client,Var1,Arrays,AttrProxy,AttrModule,ListModel1;
 Runtime.Define(Global,{
  WebSharperSpa:{
   Client:{
 ...
 Runtime.OnInit(function()
 {
  ...
  Doc=Runtime.Safe(Next.Doc);
  View1=Runtime.Safe(Next.View1);
  WebSharperSpa=Runtime.Safe(Global.WebSharperSpa);
  Client=Runtime.Safe(WebSharperSpa.Client);
  Var1=Runtime.Safe(Next.Var1);
  Arrays=Runtime.Safe(Global.WebSharper.Arrays);
  AttrProxy=Runtime.Safe(Next.AttrProxy);
  AttrModule=Runtime.Safe(Next.AttrModule);
